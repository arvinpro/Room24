  ...
  <div className="container mx-auto max-w-6xl flex flex-col">
    <div className="text-center mb-20">
      <motion.h2
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="text-4xl md:text-4xl mb-4"
      >
        Travel Made Easy
      </motion.h2>
      <motion.p
    ...
    <div className="relative flex-1 flex flex-col items-center justify-center sm:grid sm:grid-cols-3 sm:items-end gap-6">
      {/* Image 1 - Bottom Left */}
      <motion.div className="flex justify-center items-center relative bottom-25">
        <motion.div
      ...
      {/* Image 3 - Center */}
      <motion.div className="flex justify-center items-center relative bottom-40">
        <motion.div
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
